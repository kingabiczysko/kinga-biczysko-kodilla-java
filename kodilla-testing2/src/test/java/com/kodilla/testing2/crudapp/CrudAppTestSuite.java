...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://kingabiczysko.github.io";
    ...
    public void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> {
                    ...
                    WebElement buttonCreateCard = theForm.findElement(By.xpath
    ...
    public void deleteTaskFromCrud(String taskName) throws InterruptedException {
        ...
        while (!driver.findElement(By.xpath(".//fieldset[contains(@class, \"button-section\")]/button[4]")).isDisplayed()) ;

        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                        .getText().equals(taskName))
                .forEach(theForm -> {
                WebElement buttonDeleteTask = theForm.findElement(By.xpath
    ...
    public boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kinga.biczysko@gmail.com");
